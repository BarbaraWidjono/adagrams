# THIS IS THE PROGRAM WE WROTE FOR THE ADAGRAMS GAME. IT WILL RUN AND SCORE CORRECTLY ON THE TERMINAL BUT ONLY PASSES 15/16 OF THE TESTS. IF YOU COMMENT OUT LINE 61, THEN THIS PROGRAM PASSES 16/16 OF THE TESTS BUT NO LONGER SCORES PROPERLY IN THE TERMINAL.
